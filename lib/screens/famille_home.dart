...
class _FamilleHomeState extends State<FamilleHome> {
          ...
          children: [
            ...
            if (_patients.isEmpty) ...[
              ...
              if (_reminders.isNotEmpty) ...[
                _buildSection('📬 Notifications', Icons.notifications_active, Colors.blue),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('Allez dans Patients pour lier une personne âgée', style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text('📋 Activités du jour', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: const Color.fromRGBO(7, 82, 96, 1))),
                TextButton(
                  onPressed: () {
                  ...
                  child: Text('Détails →', style: GoogleFonts.poppins(fontSize: 12, color: const Color.fromRGBO(7, 82, 96, 1))),
                ),
              ],
            ),
            const SizedBox(height: 8),
  ...
  Widget _buildQuickActions() {
    return Row(
      children: [
        Expanded(
          child: _buildActionCard(Icons.medical_services, 'Ajouter\nMédicament', const Color(0xFF2196F3), () {
            if (_selectedPatientEmail != null) {
              Navigator.push(context, MaterialPageRoute(
        ...
        Expanded(
          child: _buildActionCard(Icons.warning_amber, 'Signaler\nIncident', const Color(0xFFFF9800), () {
        ...
        const SizedBox(width: 8),
        Expanded(
          child: _buildActionCard(Icons.checklist, 'Activités\nQuotidiennes', const Color(0xFF4CAF50), () {
            if (_selectedPatientEmail != null) {
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => DailyActivitiesScreen(targetEmail: _selectedPatientEmail),
              ));
